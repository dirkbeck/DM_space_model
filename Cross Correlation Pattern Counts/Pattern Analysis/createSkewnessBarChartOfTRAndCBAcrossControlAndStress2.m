...
table_of_only_CB_and_TR_og_order = table_of_only_CB_and_TR;
table_of_only_CB_and_TR(1,:) = table_of_only_CB_and_TR_og_order(3,:);
table_of_only_CB_and_TR(2,:) = table_of_only_CB_and_TR_og_order(4,:);
table_of_only_CB_and_TR(3,:) = table_of_only_CB_and_TR_og_order(2,:);
table_of_only_CB_and_TR(4,:) = table_of_only_CB_and_TR_og_order(1,:);
disp(table_of_only_CB_and_TR)
...
ylabel("Skeweness")
title("CB and TR Skewness across Control and Stress 1")
