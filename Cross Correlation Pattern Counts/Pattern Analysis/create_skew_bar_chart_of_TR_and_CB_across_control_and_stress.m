...
disp(table_of_skew)
table_of_only_CB_and_TR = table_of_skew(contains(table_of_skew.("Task Type and Conc"),"TR") | (contains(table_of_skew.("Task Type and Conc"),"CB") & ~contains(table_of_skew.("Task Type and Conc"),"v CB")),:);
...
ylabel("Skeweness")
title("CB and TR Skewness across Control and Stress")