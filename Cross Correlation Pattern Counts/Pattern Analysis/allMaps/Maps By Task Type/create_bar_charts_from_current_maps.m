...
%     disp(table_of_only_what_I_want)
% 
%     table_of_only_what_I_want = sortrows(table_of_only_what_I_want,"Database");
...
for i =1:length(list_of_patterns_i_want)
    ...
    table_of_only_what_I_want(1,:) = og_table_of_only_what_i_want(1,:);
    table_of_only_what_I_want(2,:) = og_table_of_only_what_i_want(4,:);
    table_of_only_what_I_want(3,:) = og_table_of_only_what_i_want(2,:);
    table_of_only_what_I_want(4,:) = og_table_of_only_what_i_want(3,:);
